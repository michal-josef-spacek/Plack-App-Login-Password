...
$app = Plack::App::Login::Password->new(
	...
	'text' => {
		'cze' => {
			'login' => decode_utf8('Přihlašování'),
			'password_label' => 'Heslo',
			'username_label' => decode_utf8('Uživatelské jméno'),
			'submit' => decode_utf8('Přihlásit'),
			'register' => decode_utf8('Registrovat'),
		},
	},
	'title' => 'Foo',
);
...
chomp $right_ret;
$ret = $res->content;
is($ret, $right_ret, 'Get main page with translations to Czech.');
